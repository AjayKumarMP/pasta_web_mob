...
class Register extends ComponentHelpers {
  ...
  register = async (e) => {
    ...
    if (!/^[a-zA-Z0-9 ]+$/.test(name)) {
      return this.NotificationManager.warning('Name contains Special characters', 'Warning!!')
    }
    try {
    ...
    return (
      <div className="appContainer">
        ...
        <div className='cnt-nav'>
          ...
          <h4 style={{ marginLeft: '1%' }}>Register</h4>
        </div>
        </div>
        <div className="LoginWrapp">
          <form onSubmit={(e) => this.register(e)} className="forCenter">
            ...
            <button style={{ marginBottom: '0%' }} disabled={this.state.registerBtnText === 'Please Wait'} className="LogindoneBtn" >{this.state.registerBtnText}</button>
            <Link to="/login" style={{ marginBottom: '2%' }} ><button style={{marginTop: '4%'}} className="LogindoneBtn" >Login</button></Link>
          </form>
        </div>
          ...
          <div className='editPastaPopup modalContent'>
            ...
            <div className='modal-body'>
              ...
              <div>
                ...
                <button className="verifyOtp" type="submit" onClick={() => this.otpVerify()}>Verify</button><br />
