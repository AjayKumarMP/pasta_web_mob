...
import { addBowls, addMyAddress, addMyfavourites, placeOrder, addUserDetails, addKitchenId } from '../actions/actions'
...
let mapDispatchToProps = (dispatch) => {
    return {
        ...
        addKitchenId: kitchen_id => dispatch(addKitchenId(kitchen_id))
    }
}
